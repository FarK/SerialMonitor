...
map <C-F5> :call ActualizaCtags()
nnoremap <silent> <F6> :TlistToggle
map <F8> :cn
map <F7> :cp
map <F5> :wall:make
nnoremap <silent> <F12> :set spell!
...
silent only
cd ~/Paritorio/PFC/SerialMonitor
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 plotterCore.cpp
badd +0 plotter.cpp
badd +0 plotterCore.h
badd +0 plotter.h
badd +0 serialMonitor.cpp
badd +0 serialMonitor.h
args plotterCore.cpp plotter.cpp
edit serialMonitor.h
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 87 - ((58 * winheight(0) + 31) / 63)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
87
